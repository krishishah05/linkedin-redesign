      ...
      <div className="li-nav__inner">
        ...
        <div className="li-nav__items">
          ...
          <div className="li-nav__item li-nav__me" id="nav-me-wrap">
            ...
            >
              <span className="li-nav__me-avatar" id="nav-avatar" aria-hidden="true" style={{ overflow: 'hidden', padding: 0 }}>
                {currentUser ? <Avatar name={currentUser.name} size={24} photo={currentUser.photo} colorOverride={currentUser.avatarColor} /> : '?'}
              </span>
            ...
            {meOpen && (
              <div className="li-dropdown" id={meMenuId} role="menu" style={{ display: 'block', minWidth: 280 }}>
                ...
                <div style={{ padding: '4px 0 8px' }}>
                  ...
                  {/* Recruiter mode toggle — only when status is set to Recruiting */}
                  {userStatus === 'recruiting' && <button
                    type="button"
                    className="li-dropdown__item"
                    role="menuitem"
