    ...
    <div className="li-modal-overlay" style={{ display: 'flex' }}
      ...
      <div className="li-modal">
        ...
        <div className="li-modal__body" style={{ padding: 0 }}>
          <div className="li-dropdown__item" onClick={() => { if (modalData?.onRepost) modalData.onRepost(); showToast('Reposted!'); closeModal(); }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="li-dropdown__item" onClick={() => {
            copyLink(window.location.href, (msg, type) => {
              showToast(msg, type);
              if (msg === 'Link copied!') closeModal();
            });
          }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
